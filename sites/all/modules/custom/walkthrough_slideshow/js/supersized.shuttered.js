...
(function ($) {
  ...
  theme = {
    ...
    _init: function () {
      ...
      $(vars.last_slide).click(function () {
        console.log('last slide');
        api.goTo(api.options.slides.length);
      });
      ...
      $(vars.first_slide).click(function () {
      ...
      if (jQuery.support.opacity) {
        $(vars.prev_slide + ',' + vars.next_slide + ',' + vars.first_slide + ',' + vars.last_slide).mouseover(function () {
  ...
  $.supersized.themeVars = {
    ...
    first_slide: '#firstslide',		// First slide button
    last_slide: '#lastslide',		// Last slide button
