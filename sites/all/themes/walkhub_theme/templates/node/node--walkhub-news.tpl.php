...
<div class="content clearfix">
  ...
  <div class="row">
    ...
    <div class="small-5 columns subcont">
      <?php if ($variables['field_wh_screening']): ?>
        <h4><?php print t('Attached Screening'); ?> </h4>
        <?php print render($content['field_wh_screening']); ?>
      <?php endif; ?>

      <?php if ($variables['field_wh_news_image']): ?>
